	...
	public function output_callback() {
		...
		?>
			<fieldset class="<?php echo implode( ' ', $classes ); ?>">
				...
				<?php else : ?>
					<input type="text" placeholder="<?php echo esc_attr( $this->args['placeholder'] )?>" class="all-options" name="<?php echo $this->args['id']?>" id="<?php echo $this->args['id']?>" value="<?php echo get_option( $this->args['id'] )?>">
				<?php endif; ?>
				<p class="description">
