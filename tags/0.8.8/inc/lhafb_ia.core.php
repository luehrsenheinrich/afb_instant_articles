...
class AFBInstantArticles {
	...
	public function admin_scripts(){
		wp_register_style( 'afbia_admin_style', LHAFB__PLUGIN_URL . 'admin/admin.css', false, '0.8.8' );
		wp_enqueue_style( 'afbia_admin_style' );

		wp_enqueue_script("afbia_admin_script", LHAFB__PLUGIN_URL . 'admin/admin.min.js', array("jquery", "wp-util"), '0.8.8', true);
	}
